...
alter table "public"."project" drop constraint "project_category_id_fkey";

alter table "public"."project" drop constraint "project_profile_id_fkey";

alter table "public"."quote" drop constraint "quote_project_id_fkey";
...
alter table "public"."quote" drop column "project_id";

alter table "public"."quote" add column "category_id" bigint;

alter table "public"."quote" add column "description" text;

alter table "public"."quote" add column "title" text;
